function alterarTexto(){
    // var objeto = document.getElementsByTagName("p")[0];
     ...
     var cell21 = document.createTextNode("2");
     var cell22 = document.createTextNode("Leticia");
     ...
     ntabela.style.border = "10px solid #939";
     l1col1.style.border = "10px solid #939";
     l1col2.style.border = "10px solid #939";
     l2col1.style.border = "10px solid #939";
     l2col2.style.border = "10px solid #939";
